...
public class LineAnalyzer {
     ...
     * @throws FileNotFoundException
     */
    public static ArrayList lineAnalyzer() throws FileNotFoundException, SQLException 
    {
        ...
        connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/javaproject","root","Password");
        ...
        for (String word : list)//going over every list element and comparing it to the listofwords
        {
            ...
            if (duplicate == false)//if its a new word add the word to the list of words
            {
                ...
                statement.executeUpdate("insert into words(new_words) values('" + word + "')");
            }
        }
        ...
        results = statement.executeQuery("SELECT * FROM words");
        ...
        {
            answer.add(listOfWords.toString());
        }
